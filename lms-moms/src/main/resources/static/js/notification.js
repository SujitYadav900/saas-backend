...
function getNotification() {
    $.ajax({
        url: notificationurlget + "?offset=0&limit=10",
        type: 'GET',
        success: function (json) {
            ...
            var clickunreadcount = 0;
            var notiunreadcount = 0;
            for (var i = 0; i < json.length; i++) {


                switch (json[i].innerSubject) {
                    case "TASK":
                        message = json[i].message
                        tasknotihtml = tasknotihtml + "  <li  hidjson='" + JSON.stringify(json[i]) + "' title='" + message + "'><a  class=\"border-gray\"><div class=\"pull-left\"> </div><h4>" + json[i].subject + "</h4><p class='takemetonotification' style='word-wrap: break-word; width: 250px; white-space:normal;cursor: pointer;'>" + message + "</p><span class=\"badge badge-success badge-massege\"><small class=\"smalltag snoozenotify\">Snooze <i class=\"hvr-buzz-out fa fa-clock-o\"></i></small> <small class=\"smalltag completenotification\">Complete <i class=\"hvr-buzz-out fa fa-check\"></i></small><small class=\"smalltag\">" + json[i].notificationTiming + "</small></span></a></li> ";
                        if (json[i].readStatus == false) {
                            taskunreadcount++;
                        }
                        break;
                    ...
                    case "CLICK":
                        message = json[i].message;
                        clicknotiyhtml = clicknotiyhtml + "  <li  hidjson='" + JSON.stringify(json[i]) + "' title='" + message + "'><a  class=\"border-gray\"><div class=\"pull-left\"> </div><h4>" + json[i].subject + "</h4><p class='takemetonotification' style='word-wrap: break-word; width: 250px; white-space:normal;cursor: pointer;'>" + message + "</p><span class=\"badge badge-success badge-massege\"><small class=\"smalltag snoozenotify\">Snooze <i class=\"hvr-buzz-out fa fa-clock-o\"></i></small> <small class=\"smalltag completenotification\">Complete <i class=\"hvr-buzz-out fa fa-check\"></i></small><small class=\"smalltag\">" + json[i].notificationTiming + "</small></span></a></li> ";
                    ...
                    case "NOTIFY":
                        ...
                        message = json[i].message;
                        notihtml = notihtml + "  <li  hidjson='" + JSON.stringify(json[i]) + "' title='" + message + "'><a  class=\"border-gray\"><div class=\"pull-left\"> </div><h4>" + json[i].subject + "</h4><p class='takemetonotification' style='word-wrap: break-word; width: 250px; white-space:normal;cursor: pointer;'>" + message + "</p><span class=\"badge badge-success badge-massege\"><small class=\"smalltag snoozenotify\">Snooze <i class=\"hvr-buzz-out fa fa-clock-o\"></i></small> <small class=\"smalltag completenotification\">Complete <i class=\"hvr-buzz-out fa fa-check\"></i></small><small class=\"smalltag\">" + json[i].notificationTiming + "</small></span></a></li> ";
            ...
            $('#taskunreadcount').html(checkZero(taskunreadcount));
            $('#clickunreadcount').html(checkZero(clickunreadcount));
            $('#notiunreadcount').html(checkZero(notiunreadcount));
            $('#taskul').html(tasknotihtml);
            $('#notifyul').html(notihtml);
            $('#clickul').html(clicknotiyhtml);
        },
        error: function (err) {
...
//
//
//         switch (notification.innerSubject) {
//             case "TASK":
//                 var count = parseInt($('#taskunreadcount').html() || 0);
//                 count++;
//                 var message = notification.message
//                 var html = "<li  hidjson='" + JSON.stringify(notification) + "' title='" + message + "'><a  class=\"border-gray\"><div class=\"pull-left\"> </div><h4>" + notification.subject + "</h4><p class='takemetonotification'>" + message + "</p><span class=\"badge badge-success badge-massege\"><small class=\"smalltag snoozenotify\">Snooze <i class=\"hvr-buzz-out fa fa-clock-o\"></i></small> <small class=\"smalltag completenotification\">Complete <i class=\"hvr-buzz-out fa fa-check\"></i></small><small class=\"smalltag\">" + notification.notificationTiming + "</small></span></a></li> ";
//                 $('#taskul').prepend(html);
//                 $('#taskunreadcount').html(count);
//
//                 showNotificationwithMessageAndHeader(message,"New Task Reminder  <i class='hvr-buzz-out fa fa-warning'></i>")
//
//                 break;
//             case "CLICK":
//                 var count = parseInt($('#clickunreadcount').html() || 0);
//                 count++;
//                 var message = notification.message;
//                 var html = "  <li  hidjson='" + JSON.stringify(notification) + "' title='" + message + "'><a  class=\"border-gray\"><div class=\"pull-left\"> </div><h4>" + notification.subject + "</h4><p class='takemetonotification'>" + message + "</p><span class=\"badge badge-success badge-massege\"><small class=\"smalltag snoozenotify\">Snooze <i class=\"hvr-buzz-out fa fa-clock-o\"></i></small> <small class=\"smalltag completenotification\">Complete <i class=\"hvr-buzz-out fa fa-check\"></i></small><small class=\"smalltag\">" + notification.notificationTiming + "</small></span></a></li> ";
//                 $('#clickul').prepend(html);
//                 $('#clickunreadcount').html(count);
//                 showNotificationwithMessageAndHeader(message,"New Click  <i class='hvr-buzz-out fa fa-warning'></i>")
//
//                 break;
//             case "NOTIFY":
//                 var count = parseInt($('#notiunreadcount').html() || 0);
//                 count++;
//                 var message = notification.message;
//                 var html = "  <li  hidjson='" + JSON.stringify(notification) + "' title='" + message + "'><a  class=\"border-gray\"><div class=\"pull-left\"> </div><h4>" + notification.subject + "</h4><p class='takemetonotification'>" + message + "</p><span class=\"badge badge-success badge-massege\"><small class=\"smalltag snoozenotify\">Snooze <i class=\"hvr-buzz-out fa fa-clock-o\"></i></small> <small class=\"smalltag snoozenotify\">Complete <i class=\"hvr-buzz-out fa fa-check\"></i></small><small class=\"smalltag\">" + notification.notificationTiming + "</small></span></a></li> ";
//                 $('#notifyul').prepend(html);
//                 $('#notiunreadcount').html(count);
//                 showNotificationwithMessageAndHeader(message,"New Notification  <i class='hvr-buzz-out fa fa-warning'></i>")
//
//                 break;
//         }
//
...
$(document).on("click", ".completenotification", function () {
    var json = JSON.parse($(this).closest("li").attr("hidjson"));
    var message = "You Have Completed This Notification?";
    if (json.innerSubject == "TASK") {
        message = "You Have Completed This Task?"
    } else if (json.innerSubject == "CLICK") {
        message = "You Have Taken Action On This Click?"
    }
        ...
        .then((willDelete) => {
            if (willDelete) {
                $.ajax({
                    ...
                    url: urlprefixapplication + "/api/notification/updatereadstatus?id=" + json.id,
                    success: function (html) {

                        getNotification()

                        if(typeof reloadDashboardTaskTable !== "undefined"){
                            reloadDashboardTaskTable();
                        }
...
$(document).on("click", ".takemetonotification", function () {
    var json = JSON.parse($(this).closest("li").attr("hidjson"));
    var url = urlprefixapplication + "/"+json.redirectUrl;
    location.href = url;

});
$(document).on("click", ".snoozenotify", function () {
    var json = JSON.parse($(this).closest("li").attr("hidjson"));
    swal({
        title: "Are you sure?",
        text: "You Want To Snooze This Notification ?",
        icon: "warning",
        buttons: true,
        dangerMode: true,
    })
        .then((willDelete) => {
            if (willDelete) {
                ...
                $.ajax({
                    type: "GET",
                    contentType: "application/json",
                    url: urlprefixapplication + "/html/snoozenotification.html",
                    success: function (html) {

                        $('#dynamicformbodymodel').html(html);
                        $('#dunamicmodelheader').html("Snooze Notification");
                        $('#dynamicformmodel').modal("show");
                        $('#idhiddensnooze').val(json.id);
                        $('#prevdatesnooze').val(json.notificationTiming)
...
function checkpromptnotification() {
    var taskunreadcount = $('#taskunreadcount').html() || 0;
    var clickunreadcount = $('#clickunreadcount').html() || 0;
    var notiunreadcount = $('#notiunreadcount').html() || 0;
    if (irratenotificationtask == "1") {
        if (taskunreadcount > 0) {

            showNotificationwithMessageAndHeader("You Have Unread Task!!Kindly Complete It Or Snooze It !!","Unread Task!!  <i class='hvr-buzz-out fa fa-warning'></i>")
        }
    }
    if (irratenotificationclick == "1") {


        if (clickunreadcount > 0) {


            showNotificationwithMessageAndHeader("You Have Unread Click Action!!Kindly Complete It Or Snooze It !!","Unread Click Action!!  <i class='hvr-buzz-out fa fa-warning'></i>")

        }
    }
    if (irritateNotificationNoti == "1") {

        if (notiunreadcount > 0) {

            showNotificationwithMessageAndHeader("You Have Unread Notification!!Kindly Complete It Or Snooze It !!","Unread Notification!!  <i class='hvr-buzz-out fa fa-warning'></i>")
...
setInterval(function () {
    checkpromptnotification()
}, 10000);


$(document).on("submit", "#snoozenotification", function (e) {
    e.preventDefault();
    $.ajax({
        type: "POST",
        contentType: "application/json",
        url: snoozenotificationurl + "?id=" + $('#idhiddensnooze').val() + "&timinginmins=" + $('#minstosnooze').val() + "&beforeTime=" + $('#prevdatesnooze').val(),
        success: function (html) {
