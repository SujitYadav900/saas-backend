            ...
            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-4">
               <div id="cardbox2">
                  <div class="statistic-box">
                     ...
                     <div class="counter-number pull-right">
                        <span class="count-number" id="totalticketclosed"></span>
                        <span class="slight"><i class="fa fa-play fa-rotate-270"> </i>
                              </span>
                     </div>
...
<script>
   ...
   function loaddefaultparams(){
      ...
      var  url = "userlist="+userlist+"&startdate="+startdate+"&enddate="+enddate+"&flag="+flag+"&searchvalue="+statussearch;



      $.ajax({
         url: "${pageContext.request.contextPath}/api/reportallticket/getreport?"+url,
         type: 'GET',
         success: function (json) {
            ...
            for(var i=0;i<json.length;i++)
            {
               ...
               if(json[i].seq==2)
               {
                  ...
                  $('#totalticketclosed').html(totalclosedtickets)
               }
   ...
   $("#filterform").on("submit", function (e) {
      ...
      var urlparams= "userid="+userlist+"&startdate="+startdate+"&enddate="+enddate+"&flag="+flag+"&statussearch="+statussearch+"&datefiltertype="+datefiltertype;
   ...
   function loadselect() {
      ...
      if(temp_flag == 1){
         ...
         $("#heading").html("Ticket Reports By Status");
         $("#selectlabel").html("Select Status");
         temp_url = "${pageContext.servletContext.contextPath}/api/leadticketstatus/getallactive"
         temp_html = "<option value=''>---Select Ticket Status---</option>";
         fetchselect(temp_url,temp_html);

      }
      else if(temp_flag == 2){
       $("#heading").html("Ticket Reports By Priority");
       $("#selectlabel").html("Select Priority");
         temp_url = "${pageContext.servletContext.contextPath}/api/priority/getallactive"
         temp_html = "<option value=''>---Select Ticket Priority---</option>";
         fetchselect(temp_url,temp_html);
      }

      else if(temp_flag == 3){

         $("#heading").html("Ticket Reports By Type");
         $("#selectlabel").html("Select Type");
         temp_url = "${pageContext.servletContext.contextPath}/api/tickettype/getallactive"
         temp_html = "<option value=''>---Select Ticket Type---</option>";
         fetchselect(temp_url,temp_html);
      }
   ...
   $(document).on("click",".takemetotable",function () {
      ...
      switch (flag) {
         case "1":
            ticketstatus=statussearch;
            break;
         case "2":
            ticketpriority=statussearch;
            break;
         case "3":
            tickettype=statussearch;
      ...
      switch (hidtype) {
         ...
         case "status":
            ...
            var urlparams="ticketstatus="+ticketstatus+"&ticketPriority="+ticketpriority+"&ticketType="+tickettype+"&userFilter="+userfilter+"&datefilter="+datefilter+"&datevalue="+customdate+"&searchvalue="+searchstring+"&datefiltertype="+datefiltertype;
