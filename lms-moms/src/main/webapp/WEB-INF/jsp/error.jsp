    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="error-text">
                <h1>OOPS!!</h1>
                <h3><span></span><br class="hidden-xs"> Something went wrong!</h3>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-sm-12">
            <div class="error-desc">
                <p>Sorry, the application encountered some issue while processing your request. Try checking the URL for error, then hit the
