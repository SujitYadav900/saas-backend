        ...
        <section class="content-header">
            <div class="header-icon">
                ...
                <div class="header-title">
                    <h1>Features</h1>
                    <a href="#" class="btn btn-add" data-toggle="modal" data-target="#addProduct" title="Add new product"><i class="fa fa-plus"></i> Add Feature</a>
                </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header modal-header-primary">
                            ...
                            <h3><i class="fa fa-plus m-r-5"></i> Add New Feature</h3>
                        </div>
                                    ...
                                    <form class="form-horizontal" id="createForm">
                                        <fieldset>
                                            ...
                                            <div class="col-md-8 form-group">
                                                ...
                                                <div class="form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="radio" class="form-check-input" name="optradionew" value="true" checked>Active
                                                    </label>
                                                </div>
                                                <div class="form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="radio" class="form-check-input" name="optradionew" value="false">Not Active
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-8 form-group">
                                                ...
                                                <input type="text"  maxlength="100" placeholder="Feature Name"  id="name" class="form-control" required>
                                            </div>
                                            <!-- Text input-->
                                            <div class="col-md-8 form-group">
                                                <label class="control-label">Description</label>
                                                <input type="text" maxlength="256" placeholder="Feature Description"  id="description" class="form-control" required>
                                            </div>
...
<script>
    ...
    $('#createForm').submit(function (e) {
        ...
        if($('#createBtn').html() == 'Create'){
             ...
             url = "${pageContext.request.contextPath}/api/features/insert";
             map = {
             ...
             url = "${pageContext.request.contextPath}/api/features/update";
             map = {
                id:$('#id').val(),
                name: $('#name').val(),
       ...
       $.ajax({
            ...
            if($('#createBtn').html() == 'Create'){
                ...
                swal({
                    title: "Success!",
                    text: "Successfully Created Feature",
                    icon: "success",
                    button: "Ok!",
                });
            }
                ...
                swal({
                    title: "Success!",
                    text: "Successfully Updated Feature",
                    icon: "success",
                    button: "Ok!",
                });
    ...
    var table=  $('#table').DataTable( {
        ajax: {
            url: '${pageContext.servletContext.contextPath}/api/features/get',
            dataSrc: '',
            "data": {
                "flag": 1,
   ...
   function clearData()
   {
       ...
       $('#price').val("");
       $('#productcode').val("");
       $("input[name=optradionew][value='true']").prop('checked', true);
