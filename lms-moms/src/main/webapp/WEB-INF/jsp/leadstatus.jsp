...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            <div class="header-icon">
                ...
                <div class="header-title" >
                    <h1>Lead Status</h1>
                    <a href="#" class="btn btn-add" data-toggle="modal" data-target="#addLeadStatus" title="Add new lead status"><i class="fa fa-plus"></i> Add Lead Status</a>
                </div>
        ...
        <section class="content">
            ...
            <!--======================================================ADD NEW =================================================================== -->
            <div class="modal fade" id="addLeadStatus" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header modal-header-primary">
                            <button type="button" onclick="clearData()" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h3><i class="fa fa-plus m-r-5"></i> Add New Lead Status</h3>
                        </div>
                                    ...
                                    <form class="form-horizontal" id="createForm">
                                        <fieldset>
                                            ...
                                            <div class="col-md-8 form-group" hidden>
                                                ...
                                                <input type="text" placeholder="Lead Status ID" id="id" class="form-control" >
                                            </div>

                                            <!-- Text input-->
                                            <div class="col-md-8 form-group">
                                                <label class="control-label">Name</label>
                                                <input type="text" minlength="4" maxlength="100"placeholder="Lead Status Name"  id="name" class="form-control" required>
                                            </div>
                                            <!-- Text input-->
                                            <div class="col-md-8 form-group">
                                                <label class="control-label">Description</label>
                                                <input type="text" minlength="4" maxlength="256" placeholder="Lead Status Description"  id="description" class="form-control" required>
                                            </div>
...
<script>
    $('#createForm').submit(function (e) {
        ...
        if($('#createBtn').html() == 'Create'){
            ...
            var url = "${pageContext.request.contextPath}/api/leadstatus/insert";
            var map = {
            ...
            var url = "${pageContext.request.contextPath}/api/leadstatus/update";
            var map = {
                id:$('#id').val(),
                name: $('#name').val(),
                desc: $('#description').val(),
       ...
       $.ajax({
            ...
            if($('#createBtn').html() == 'Create'){
                ...
                swal({
                    title: "Success!",
                    text: "Successfully created Lead Status",
                    icon: "success",
                    button: "Ok!",
                });
    ...
    var table=  $('#table').DataTable( {
        ajax: {
            url: '${pageContext.servletContext.contextPath}/api/leadstatus/getall',
            dataSrc: '',
            "data": {
                "flag": 1,
        ...
        "columns": [
            ...
            { "mRender": function (data, type, row) {
                ...
                return '<button type="button" class="btn btn-add btn-sm editfield" title="Update" data-toggle="modal" data-target="#addLeadStatus" ><i class="fa fa-pencil"></i></button>'
