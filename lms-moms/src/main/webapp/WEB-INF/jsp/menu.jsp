    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="header-title" >
                <h1>Menu</h1>
                    <a href="#" class="btn btn-add" data-toggle="modal" data-target="#addMenu" title="Create new menu"><i class="fa fa-plus"></i> Add Menu</a>
                </div>
                            ...
                            <div class="table-responsive">
                                <div class="table-responsive card" style="padding: 20px">
                                    <table class="table table-striped table-bordered first" id="table">
                                        <thead>
                                        <tr>
                                            <th>Name</th><th>Description</th><th>Icon</th><th>Status</th><th>Action</th>
                                        </tr>
                                        </thead>
                                        <tbody>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header modal-header-primary">
                            ...
                            <h3><i class="fa fa-plus m-r-5"></i> Add New Menu</h3>
                        </div>
                                    ...
                                    <form class="form-horizontal" id="createForm">
                                        <fieldset>
                                            ...
                                            <div class="col-md-8 form-group">
                                                ...
                                                <input type="text" minlength="4" maxlength="100" placeholder="Menu Name"  id="name" class="form-control" required>
                                            </div>
                                            <!-- Text input-->
                                            <div class="col-md-8 form-group">
                                                <label class="control-label">Description</label>
                                                <input type="text" minlength="4" maxlength="256" placeholder="Menu Description"  id="description" class="form-control" required>
                                            </div>
                                            <!-- Text input-->
                                            <div class="col-md-8 form-group">
                                                <label class="control-label">Icon <a href="#" data-toggle="modal" data-target="#iconModal"><i title="Click to view available icons" class="hvr-buzz-out fa fa-question-circle-o"></i></a></label>
                                                <input type="text" minlength="4" maxlength="256" placeholder="Menu Icon"  id="icon" class="form-control" required>
                                            </div>
...
<script>
    $('#createForm').submit(function (e) {
        ...
        if($('#createBtn').html() == 'Create'){
            ...
            var url = "${pageContext.request.contextPath}/api/menu/insert";
            var map = {

                menuName: $('#name').val(),
                menuDesc: $('#description').val(),
                icon: $('#icon').val(),
            ...
            var url = "${pageContext.request.contextPath}/api/menu/update";
            var map = {
                id:$('#id').val(),
                menuName: $('#name').val(),
                menuDesc: $('#description').val(),
    ...
    var table=  $('#table').DataTable( {
        ...
        "columns": [
            ...
            { "mRender": function (data, type, row) {
                    ...
                    return "<a hidatr='"+JSON.stringify(row)+"' style='display: none'></a><span>"+row.menuName+"</span>";
            ...
            { "mRender": function (data, type, row) {
                ...
                return '<button type="button" class="btn btn-add btn-sm editfield" data-toggle="modal" data-target="#addMenu" title="Update"><i class="fa fa-pencil"></i></button>';
   ...
   function clearData()
   {
    ...
    $(document).on("click",".editfield",function () {
        ...
        $('#id').val(json.id);
        $('#name').val(json.menuName);
        $('#description').val(json.menuDesc)
        $('#icon').val(json.icon)
