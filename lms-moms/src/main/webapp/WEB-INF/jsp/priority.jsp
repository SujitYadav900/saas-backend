    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="buttonexport">
                    <a href="#" class="btn btn-add" data-toggle="modal" title="Add New Ticket Priority" data-target="#addPriority"><i class="fa fa-plus"></i> Add Ticket Priority</a>
                </div>
        ...
        <section class="content">
                            ...
                            <div class="table-responsive">
                                <div class="table-responsive card" style="padding: 20px">
                                    <table class="table table-striped table-bordered first" id="table">
                                        <thead>
                                        <tr>
                                            <th>Name</th><th>Description</th><th>Colour</th><th>Status</th><th>Action</th>
                                        </tr>
                                        </thead>
                                        <tbody>
            ...
            <!--======================================================ADD NEW Department=================================================================== -->
            <div class="modal fade" id="addPriority" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header modal-header-primary">
                            <button type="button" onclick="clearData()" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h3><i class="fa fa-plus m-r-5"></i> Add New Priority</h3>
                        </div>
                                    ...
                                    <form class="form-horizontal" id="createForm">
                                        <fieldset>
                                            ...
                                            <div class="col-md-8 form-group">
                                                ...
                                                <input type="text" minlength="3" maxlength="100" placeholder="Ticket Priority Name"  id="name" class="form-control" required>
                                            </div>
                                            <div class="col-md-8 form-group">
                                            ...
                                            <div class="col-md-8 form-group">
                                                ...
                                                <input type="text" minlength="4" maxlength="256" placeholder="Ticket Priority Description"  id="description" class="form-control" required>
                                            </div>
...
<script>
    $('#createForm').submit(function (e) {
        ...
        if($('#createBtn').html() == 'Create'){
            ...
            var url = "${pageContext.request.contextPath}/api/priority/insert";
            var map = {
                color:$('#color').val(),
                name: $('#name').val(),
            ...
            var url = "${pageContext.request.contextPath}/api/priority/update";
            var map = {
                id:$('#id').val(),
                color:$('#color').val(),
                name: $('#name').val(),
       ...
       $.ajax({
            ...
            if($('#createBtn').html() == 'Create'){
                ...
                swal({
                    title: "Success!",
                    text: "Successfully Created Priority",
                    icon: "success",
                    button: "Ok",
                });
                ...
                swal({
                    title: "Success!",
                    text: "Successfully Updated Priority",
                    icon: "success",
                    button: "Ok",
                });
    ...
    var table=  $('#table').DataTable( {
        ajax: {
            url: '${pageContext.servletContext.contextPath}/api/priority/getall',
            dataSrc: '',
            "data": {
                "flag": 1,
        ...
        "columns": [
            ...
            { "mRender": function (data, type, row) {
                ...
                return '<button type="button" class="btn btn-add btn-sm editfield" title="Update" data-toggle="modal" data-target="#addPriority" ><i class="fa fa-pencil"></i></button>';
