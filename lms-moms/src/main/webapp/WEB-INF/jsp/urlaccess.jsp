    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <div class="header-title" >
                <h1>URL Access</h1>
                    <a href="#" class="btn btn-add" data-toggle="modal" onclick="clearData()" data-target="#addUrlAccess" title="Add new URL"><i class="fa fa-plus"></i> Add URL Access</a>
                </div>
        ...
        <section class="content">
            ...
            <!--======================================================ADD NEW ROLE=================================================================== -->
            <div class="modal fade" id="addUrlAccess" tabindex="-1" role="dialog" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header modal-header-primary">
                            <button type="button" onclick="clearData()" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                            <h3><i class="fa fa-plus m-r-5"></i> Add New URL Access</h3>
                        </div>
                                    ...
                                    <form class="form-horizontal" id="createForm">
                                        <fieldset>
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <div class="form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="radio" class="form-check-input" name="showOnMenu" value="1" checked>Yes
                                                    </label>
                                                </div>
                                                <div class="form-check-inline">
                                                    <label class="form-check-label">
                                                        <input type="radio" class="form-check-input" name="showOnMenu" value="0">No
                                                    </label>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" minlength="4" maxlength="100" placeholder="Page Name"  id="pageName" class="form-control" required>
                                            </div>
                                            <!-- Text input-->
                                            <div class="col-md-6 form-group">
                                                <label class="control-label">Description</label>
                                                <input type="text" minlength="4" maxlength="256" placeholder="Page Description"  id="pageDesc" class="form-control" required>
                                            </div>
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" placeholder="URL"  id="url" class="form-control" required>
                                            </div>
                                            <!-- Text input-->
                                            <div class="col-md-6 form-group">
                                                <label class="control-label">Page Icon <a href="#" data-toggle="modal" data-target="#iconModal"><i title="Click to view available icons" class="hvr-buzz-out fa fa-question-circle-o"></i></a></label>
                                                <input type="text" placeholder="Page Icon"  id="pageIcon" class="form-control" >
                                            </div>
                                            <!-- Text input-->
                                            <div class="col-md-6 form-group">
                                                <label class="control-label">Index Sequence</label>
                                                <input type="number" min="1" max="10" placeholder="Index Sequence"  id="indexSeq" class="form-control" required>
                                            </div>
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text" minlength="4" maxlength="100" placeholder="Role Name"  id="roleName" class="form-control" required>
                                            </div>
...
<script>
       ...
       $('#createForm').submit(function (e) {
        ...
        if($('#createBtn').html() == 'Create'){
            ...
            var url = "${pageContext.request.contextPath}/api/urlaccess/insert";
            var map = {
                ...
                index: $('#indexSeq').val(),
                showOnMenu: $("input[name='showOnMenu']:checked").val(),
                roleName: $('#roleName').val(),
                menuId: $('#menudropdown').val(),
            ...
            var url = "${pageContext.request.contextPath}/api/urlaccess/update";
            var map = {
                id:$('#id').val(),
                pageName: $('#pageName').val(),
                pageDesc: $('#pageDesc').val(),
       ...
       $.ajax({
            ...
            if($('#createBtn').html() == 'Create'){
                ...
                swal({
                    title: "Success!",
                    text: "Successfully created URL Access",
                    icon: "success",
                    button: "Ok!",
                });
                ...
                swal({
                    title: "Success!",
                    text: "Successfully Updated URL Access",
                    icon: "success",
                    button: "Ok!",
                });
    ...
    //=====================POPULATING SELECT WITH MENU TABLE===============================
    $(
        $.ajax({
            type: "GET",
            url: '${pageContext.servletContext.contextPath}/api/menu/getall',
            cache: false,
            ...
            success: function(data){
                ...
                {
                    html=html+"<option value='"+data[i].id+"'>"+data[i].menuName+"</option>"
                }
                $('#menudropdown').html(html)
    ...
    var table=  $('#table').DataTable( {
        ajax: {
            url: '${pageContext.servletContext.contextPath}/api/urlaccess/getall',
            dataSrc: '',
            "data": {
                "flag": 1,
        ...
        "columns": [
            ...
            { "mRender": function (data, type, row) {
                    ...
                    return "<a hidatr='" + JSON.stringify(row) + "' style='display: none'></a><span>"+row.pageName+"</span>";
            ...
            { "mRender": function (data, type, row) {
                    return '<span style="word-wrap:break-word; width:300px;display: block;">'+row.url+' </span> ' ;
                }},
            {
                "data":"pageIcon"
            },
            ...
            { "mRender": function (data, type, row) {
                ...
                return '<button type="button" class="btn btn-add btn-sm editfield" data-toggle="modal" data-target="#addUrlAccess" title="Update" ><i class="fa fa-pencil"></i></button>';
   ...
   function clearData()
   {
       ...
       $('#pageName').val("");
       $('#pageDesc').val("");
       // $("input[name='optradionew']:checked").val("1");
       $('#url').val("");
       $('#pageIcon').val("");
       $('#indexSeq').val("");
       //$("input[name='showOnMenu']:checked").val("1");
       $('#roleName').val("");
       $('#menudropdown').val("");
   }
    ...
    $(document).on("click",".editfield",function () {
        ...
        $('#pageDesc').val(json.pageDesc);
        $("input[name=optradionew][value=" + json.status + "]").prop('checked', true);
        $('#url').val(json.url);
        $('#pageIcon').val(json.pageIcon);
        $('#indexSeq').val(json.index);
        $("input[name=showOnMenu][value=" + json.showOnMenu + "]").prop('checked', true);
        $('#roleName').val(json.roleName);
        $('#menudropdown').val(json.menuId);
