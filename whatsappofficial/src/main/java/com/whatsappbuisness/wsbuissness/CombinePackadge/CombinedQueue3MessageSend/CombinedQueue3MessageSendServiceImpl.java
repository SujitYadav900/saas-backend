...
@Service
public class CombinedQueue3MessageSendServiceImpl implements CombinedQueue3MessageSendService {
    private static final Logger logger = LoggerFactory.getLogger(CombinedQueue3MessageSendServiceImpl.class);
...
//        return messageEntryResponseDao;
    ...
    public void insertToQue(MessageDao messageDao) {
        mqqueService.pushToQue(QueName.Main_Que3.routing, QueName.Main_Que3.queName, messageDao);
    }

    public void insertToMainQue3(List<MessageDao> messageDaoList) {
        mqqueService.sendListOfMessages(messageDaoList, QueName.Main_Que3.routing, QueName.Main_Que3.queName );
    }
