...
@Component
public class ContactCheck3Que {

    private static final Logger logger = LoggerFactory.getLogger(ContactCheck3Que.class);
    ...
    @RabbitListener(queues = "Contact_Que3", concurrency = "5")
    ...
    private void forwardMessage(MessageDao messageDao) {
        rabbitMqqueService.pushToQue(QueName.SendWs_QUE3.routing, QueName.SendWs_QUE3.queName, messageDao);
    }
